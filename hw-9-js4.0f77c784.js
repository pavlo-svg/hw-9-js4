...
function renderContacts() {
    listRef.innerHTML = contacts.map((contact, index)=>`
        <li>
          <h2>${contact.name} ${contact.surname}</h2>
          <p>Email: ${contact.email}</p>
          <p>\u{422}\u{435}\u{43B}\u{435}\u{444}\u{43E}\u{43D}: ${contact.phone}</p>
...
},{}]},["7wZbQ","2R06K"], "2R06K", "parcelRequiref9e7", {})

//# sourceMappingURL=hw-9-js4.0f77c784.js.map
